...
struct GlobalProcessCutSimParam : public o2::conf::ConfigurableParamHelper<GlobalProcessCutSimParam> {
  ...
  double CUTGAM = 1.0E-6; // GeV --> 1 MeV
  double CUTELE = 1.0E-6; // GeV --> 1 MeV
  double CUTNEU = 1.0E-6; // GeV --> 1 MeV
  double CUTHAD = 1.0E-6; // GeV --> 1 MeV
  double CUTMUO = 1.0E-6; // GeV --> 1 MeV
  double BCUTE = 1.0E-6;  // GeV --> 1 MeV
  double BCUTM = 1.0E-6;  // GeV --> 1 MeV
  double DCUTE = 1.0E-6;  // GeV --> 1 MeV
  double DCUTM = 1.0E-6;  // GeV --> 1 MeV
  double PPCUTM = 1.0E-6; // GeV --> 1 MeV
