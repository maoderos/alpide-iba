...
do
  ...
  do
    ...
    o2-sim -m MFT -e TGeant3 -g boxgen -j $workers -n $dEvents --configKeyValues 'BoxGun.pdg=2212 ; BoxGun.eta[0]=179.70 ; BoxGun.eta[1]=180.00; BoxGun.prange[0]=0.0003; BoxGun.prange[1]=0.00065; BoxGun.number=100; Diamond.position[0]=-2.00;Diamond.position[1]=-3.546;Diamond.position[2]=80.000;Diamond.width[2]=0; MFTBase.buildHeatExchanger=false; MFTBase.buildFlex=false; MFTBase.minimal=true;';
